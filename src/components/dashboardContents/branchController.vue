<template>
    <v-container>
        ...
        <v-dialog v-model="dialog" persistent max-width="600px">
            <v-card>
                <v-card-title> <span class="headline">Branch Profile</span> </v-card-title>
                <v-card-text>
                    <v-container>
                        <v-row>
                            <v-col cols="12">
                            ...
                            <v-col cols="12">
                                <v-text-field label="Phone Number*" v-model="form.phoneNumber" required>
                                </v-text-field>
                            </v-col>
                        </v-row>
...
export default {
    ...
    methods: {
        ...
        deleteData(deleteId){ //mengahapus data             
            var uri = this.$apiUrl + '/branch/' + deleteId; //data dihapus berdasarkan id 
